...
{
	// Initialization
	GDExtensionBool GDE_EXPORT august21st_game_library_init(GDExtensionInterfaceGetProcAddress p_get_proc_address, GDExtensionClassLibraryPtr p_library, GDExtensionInitialization *r_initialization)
	{
